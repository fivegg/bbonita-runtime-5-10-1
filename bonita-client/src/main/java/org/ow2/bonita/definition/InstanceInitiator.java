...
public class InstanceInitiator implements RoleMapper {
  ...
  public Set<String> searchMembers(QueryAPIAccessor accessor, ProcessInstanceUUID instanceUUID, String roleName) throws Exception {
    final QueryRuntimeAPI queryRuntimeAPI = accessor.getQueryRuntimeAPI(AccessorUtil.QUERYLIST_JOURNAL_KEY);
    final String instanceInitiator = queryRuntimeAPI.getLightProcessInstance(instanceUUID).getStartedBy();
    Set<String> result = new HashSet<String>();
    result.add(instanceInitiator);
    return result;
  }

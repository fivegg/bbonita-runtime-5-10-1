...
public class PrivilegeNotFoundException extends BonitaException {
  ...
  public PrivilegeNotFoundException(final String id, final String name) {
    super(ExceptionManager.getInstance().getIdMessage(id)
        + ExceptionManager.getInstance().getMessage("PNFE", name));
    this.name = name;
  }
  
  public PrivilegeNotFoundException(PrivilegeNotFoundException e) {
    super(e.getMessage());
    this.name = e.getName();
  }

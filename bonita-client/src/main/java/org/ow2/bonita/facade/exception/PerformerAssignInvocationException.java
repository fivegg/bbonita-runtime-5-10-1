...
public class PerformerAssignInvocationException extends BonitaRuntimeException {
  ...
  public PerformerAssignInvocationException(String id, String performerAssignInfo, Throwable cause) {
    super(ExceptionManager.getInstance().getIdMessage(id)
    		+ ExceptionManager.getInstance().getMessage("PAIE1", performerAssignInfo), cause);
  }

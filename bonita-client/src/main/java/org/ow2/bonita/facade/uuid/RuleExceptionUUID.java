...
/**
 * This class implements the UUID that can be used when creating Rules.
 */
public class RuleExceptionUUID extends AbstractUUID {
  ...
  public RuleExceptionUUID(final RuleExceptionUUID src) {
    super(src);
  }

  public RuleExceptionUUID(final String value) {
    super(value);
  }

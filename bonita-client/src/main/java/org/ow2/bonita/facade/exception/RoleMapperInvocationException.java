...
public class RoleMapperInvocationException extends BonitaRuntimeException {
  ...
  public RoleMapperInvocationException(String id, String roleMapperInfo, Throwable cause) {
  	super(ExceptionManager.getInstance().getIdMessage(id)
  			+ ExceptionManager.getInstance().getMessage("RMIE1", roleMapperInfo), cause);
  }

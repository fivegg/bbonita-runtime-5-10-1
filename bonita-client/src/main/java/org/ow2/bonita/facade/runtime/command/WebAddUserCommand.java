...
public class WebAddUserCommand implements Command<User> {
  ...
  private final String delegateUuid;
	 ...
	 */
	public WebAddUserCommand(final String username, final String firstName, final String lastName, final String password, final String title, final String jobTitle, final String managerUuid, final String delegateUuid, final Map<String, String> personalContactInfo, final Map<String,String> professionalContactInfo, final Map<String,List<String>> memberships, final Map<String,String> metadata) {
	...
	public User execute(Environment environment) throws Exception {
		...
		User user;
		user = identityAPI.addUser(username, password,  firstName, lastName, title, jobTitle, managerUuid, metadata);
		identityAPI.updateUserDelegee(user.getUUID(), delegateUuid);
		...
		String groupId;
		for (Entry<String,List<String>> entry : memberships.entrySet()) {

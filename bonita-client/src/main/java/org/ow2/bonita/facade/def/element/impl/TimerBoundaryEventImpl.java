...
/**
 * Engine implementation of a timer boundary event.
 * 
...
public class TimerBoundaryEventImpl extends BoundaryEventImpl implements TimerEvent {
  ...
  public TimerBoundaryEventImpl(final String eventName, final ProcessDefinitionUUID processUUID,
      final ActivityDefinitionUUID activityUUID, final TransitionDefinition exceptionTransition, final String condition) {
    super(eventName, processUUID, activityUUID, exceptionTransition);
    this.condition = condition;
  }

  public TimerBoundaryEventImpl(final TimerBoundaryEventImpl src) {
    super(src);

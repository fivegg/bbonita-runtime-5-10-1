...
/**
 * An event is a process element which defines that something appends during the process execution.
...
public interface Event extends ProcessElement, Serializable {
  ...
  /**
   * The activity definition UUID where the event appends.
   * @return the activity definition UUID where the event appends
   */

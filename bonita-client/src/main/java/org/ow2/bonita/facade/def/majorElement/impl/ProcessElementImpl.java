...
public abstract class ProcessElementImpl extends NamedElementImpl {
  ...
  /**
   * This field can be null when the related element has not been defined in the
   * process but in the package
   */
  ...
  protected ProcessElementImpl(final String name, final ProcessDefinitionUUID processDefinitionUUID) {
    super(name);
    this.processDefinitionUUID = processDefinitionUUID;
  }

  protected ProcessElementImpl(final ProcessElement processDefinitionRecord) {
    ...
    if (processDefinitionRecord.getProcessDefinitionUUID() != null) {
      processDefinitionUUID = new ProcessDefinitionUUID(processDefinitionRecord.getProcessDefinitionUUID());
    }
  }

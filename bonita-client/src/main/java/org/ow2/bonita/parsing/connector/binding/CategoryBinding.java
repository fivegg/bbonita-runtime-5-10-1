...
public class CategoryBinding extends ElementBinding {
  ...
  public Object parse(Element categoryElement, Parse parse, Parser parser) {
    ConnectorDescriptor descriptor = parse.findObject(ConnectorDescriptor.class);
    final String categoryName = getChildTextContent(categoryElement, "name");
    final String categoryIconPath = getChildTextContent(categoryElement, "icon");
    descriptor.addCategory(categoryName, categoryIconPath);
    return null;
  }
}

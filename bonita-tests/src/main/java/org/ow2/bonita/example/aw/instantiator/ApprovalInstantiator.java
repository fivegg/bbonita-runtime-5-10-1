...
public class ApprovalInstantiator implements MultiInstantiator {
  ...
  public MultiInstantiatorDescriptor execute(QueryAPIAccessor accessor, ProcessInstanceUUID instanceUUID, String activityId, String iterationId) throws Exception {

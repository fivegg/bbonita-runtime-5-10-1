 ...
 *
 */
public class JoinXor1to1TrXpdl1Test extends APITestCase {

  public void testJoinXOR1to1() throws BonitaException {
    URL xpdlUrl = this.getClass().getResource("joinXor_1to1Tr.xpdl");

 ...
 *
 */
public class TransitionConditionTest extends APITestCase {

  public void testCondition1() throws BonitaException {
    URL xpdlUrl = this.getClass().getResource("testTransitionCondition.xpdl");
  ...
  public void testCondition2() throws BonitaException {
    ...
    variables.put("str1", "modified value");

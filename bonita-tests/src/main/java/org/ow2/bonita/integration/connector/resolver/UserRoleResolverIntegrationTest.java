...
public class UserRoleResolverIntegrationTest extends APITestCase {
  ...
  public void testGetUserOfARole() throws Exception {
    ProcessDefinition process = ProcessBuilder.createProcess("groups", "1.1")
    .addGroup("Users")
      .addGroupResolver(UserRoleResolver.class.getName())
        .addInputParameter("setName", "isä")
    .addHumanTask("welcome", "Users")
    .done();

    process = getManagementAPI().deploy(getBusinessArchive(process, null, UserRoleResolver.class));
  ...
  public void testGetUsersOfARoleInDifferentGroups() throws Exception {
    ProcessDefinition process = ProcessBuilder.createProcess("groups", "1.2")
    .addGroup("Users")
      .addGroupResolver(UserRoleResolver.class.getName())
        .addInputParameter("setName", "lapsi")
    .addHumanTask("welcome", "Users")
    .done();
  ...
  public void testGetNoUsersOfAUnknownRole() throws Exception {
    ProcessDefinition process = ProcessBuilder.createProcess("groups", "1.3")
    .addGroup("Users")
      .addGroupResolver(UserRoleResolver.class.getName())
        .addInputParameter("setName", "eläin")
    .addHumanTask("welcome", "Users")
    .done();

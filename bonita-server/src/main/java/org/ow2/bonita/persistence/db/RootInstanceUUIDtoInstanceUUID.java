...
public final class RootInstanceUUIDtoInstanceUUID {
  ...
  public RootInstanceUUIDtoInstanceUUID() {
    super();
  }
  ...
  public void setRootInstanceUUID(final ProcessInstanceUUID rootInstanceUUID) {
    this.rootInstanceUUID = rootInstanceUUID;
  }

  public ProcessInstanceUUID getSubProcessInstanceUUID() {
    return subProcessInstanceUUID;
  }

  public void setSubProcessInstanceUUID(final ProcessInstanceUUID subProcessInstanceUUID) {
    this.subProcessInstanceUUID = subProcessInstanceUUID;
  }

 ...
 */
public class QuerierListAccessorBinding extends TagBinding {

  public QuerierListAccessorBinding() {
    super("queryApi", null, WireParser.CATEGORY_DESCRIPTOR);
  }
  ...
  public Object parse(final Element element, final Parse parse, final Parser parser) {
    ...
    chainDescriptor.setClassName(QuerierListAccessor.class.getName());

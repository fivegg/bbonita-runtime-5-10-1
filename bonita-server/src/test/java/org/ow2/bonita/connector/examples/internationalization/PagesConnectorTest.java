...
public class PagesConnectorTest extends InternationalizationConnectorTest {
  ...
  public void testGetAllPageInputs() {
    ...
    List<Component> list = widget.getAllPageInputs("A");
    Assert.assertEquals("SMTP server", widget.getPageName("A"));
    Assert.assertEquals(2, list.size());
    Assert.assertEquals(d, list.get(0));
    Assert.assertEquals(a, list.get(1));

    list = widget.getAllPageInputs("B");
    Assert.assertEquals("e-mail", widget.getPageName("B"));
    Assert.assertEquals(2, list.size());
  ...
  public void testGetPages() {
    ...
    Assert.assertEquals("A", pages.get(0));
    Assert.assertEquals("B", pages.get(1));
  }

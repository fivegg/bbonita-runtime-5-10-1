...
import org.ow2.bonita.connector.examples.widget.TextConnector;
import org.ow2.bonita.util.BonitaException;

public class TextConnectorTest extends ConnectorTest {

  @Override
  protected Class<? extends Connector> getConnectorClass() {
    return TextConnector.class;
  }
  ...
  public void testValidateConnector() throws BonitaException {
    ...
    ConnectorError three = new ConnectorError("e",
        new IllegalArgumentException("The Text widget does not refer to any setter"));

...
import org.ow2.bonita.connector.examples.widget.PasswordConnector;
import org.ow2.bonita.util.BonitaException;

public class PasswordConnectorTest extends ConnectorTest {

  @Override
  protected Class<? extends Connector> getConnectorClass() {
    return PasswordConnector.class;
  }
  ...
  public void testValidateConnector() throws BonitaException {
    ...
    ConnectorError one = new ConnectorError("b",
    ...
    ConnectorError three = new ConnectorError("e",
        new IllegalArgumentException("The Password widget does not refer to any setter"));
    ConnectorError four = new ConnectorError("null",
